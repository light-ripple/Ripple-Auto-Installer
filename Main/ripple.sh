#!/bin/sh
# Created by Uniminin <email> under license at time
# Refactored by Jacob Hrbek <kreyren@rixotstudio.cz> under GPLv3 license <https://www.gnu.org/licenses/gpl-3.0.en.html> in 01.07.2020 18:13:58 CET (DD.MM.YYYY HH:MM:SS TIMEZONE)

# shellcheck shell=sh # Written to be posix compatible

###! Script to configure ripple
###! We need:
###! - FIXME-DOCS
###! Requires:
###! - FIXME
