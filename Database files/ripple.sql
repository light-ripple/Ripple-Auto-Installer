...
CREATE DATABASE IF NOT EXISTS `ripple` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `ripple`;
...
INSERT IGNORE INTO `badges` (`id`, `name`, `icon`) VALUES
	...
	(1003, 'คนไทย', 'universal access'),
	(1004, 'Vanilla God (Certified by Kingkong)', 'yellow fa-check'),
...
INSERT IGNORE INTO `bancho_channels` (`id`, `name`, `description`, `public_read`, `public_write`, `status`, `temp`, `hidden`) VALUES
	...
	(3, '#Spanish', 'Spanish community', 1, 1, 1, 0, 0),
	(4, '#english', 'English community', 1, 1, 1, 0, 0),
	(5, '#admin', 'Administration', 1, 1, 1, 0, 1),
	(6, '#lobby', 'General Lobby', 1, 1, 1, 0, 1),
	(7, '#ranked', 'Ranked Maps General', 1, 0, 1, 0, 0);
...
INSERT IGNORE INTO `privileges_groups` (`id`, `name`, `privileges`, `color`) VALUES
	...
	(14, 'New Privilege Group', 33039, 'info');
